                    ...
                    <div className="col-sm-12">
                        <div className="title-box text-center">
                            ...
                            <p className="subtitle-a">
                                {props.artwork &&
                                    props.artwork.map((thing, i) => (
                                        <span className="col-12" key={thing.id}>
                                            {thing.title}
                                        </span>
                                    ))}
                            </p>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="work-box">
                            ...
                            <a href={vmarine1} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine2} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine3} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine4} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine5} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine6} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={vmarine7} data-lightbox="gallery-vmarine" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="work-box">
                            ...
                            <a href={todoList1} data-lightbox="gallery-todo" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={todoList2} data-lightbox="gallery-todo" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={todoList3} data-lightbox="gallery-todo" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="work-box">
                            ...
                            <a href={medlingos1} data-lightbox="gallery-medlingos" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={medlingos2} data-lightbox="gallery-medlingos" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={medlingos3} data-lightbox="gallery-medlingos" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                            <a href={medlingos4} data-lightbox="gallery-medlingos" style={{ display: 'none' }}>
                                jsx-a11y/anchor-has-content warning
                            </a>
                        </div>
                    </div>
...
const mapStateToProps = state => {
    return {
        artwork: state.portfolio.artwork,
    }
}
