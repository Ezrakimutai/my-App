const initState = {
    ...
    resume: {
        ...
        summary: ['Expand on that information in more depth in a few short paragraphs', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.'],
        ...
        jobs: [
            {
                ...
                company: 'Fancy LLC',
                timeframe: '2015-2020',
                summary: "List all the cool stuff you did here. Don't be shy, but be honest and specific.",
            },
            {
                title: 'Director of Stuff',
                company: 'Neato Inc.',
                timeframe: '2010-2015',
                summary: 'Highlight some accomplishments in these descriptions. Sometimes people even read them.',
            },
            {
                title: 'Developer',
                company: 'WorkJob Co.',
                timeframe: '2005-2010',
                summary: 'Action works and quantified results help explain what you really did in a job.',
            },
        ],
